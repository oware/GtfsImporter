...
#                             -------------------
#        begin                : 2013-10-16
#        copyright            : (C) 2013 by Applied Geomatics
...
# translation
SOURCES = gtfsimporter.py ui_gtfsimporter.py __init__.py gtfsimporterdialog.py
#TRANSLATIONS = i18n/gtfsimporter_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = gtfsimporter

PY_FILES = gtfsimporter.py gtfsimporterdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_gtfsimporter.py
